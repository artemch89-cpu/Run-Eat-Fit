...
// календарь плана → текущее время. Самое волатильное (календарь, «Сейчас:») —
// в конце, ближе всего к вопросу пользователя.
export function buildSystemPrompt(user) {
  return `${FROZEN_INSTRUCTIONS}

—— Дальше — данные под конкретного пользователя и текущий момент ——
